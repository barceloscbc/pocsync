package br.com.poc.sync.spring.boot.service;
...
@EnableSwagger2
@ComponentScan({ "br.com.poc.sync.spring.boot.service.model.repostiroy", "br.com.poc.sync.spring.boot.service.controller" })
